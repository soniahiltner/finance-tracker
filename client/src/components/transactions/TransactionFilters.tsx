        ...
        <div className='flex items-center justify-between gap-1 max-xs:flex-wrap'>
          <div className='flex items-center space-x-2'>
            ...
            <button
              ...
              aria-label={`${t.manage} ${t.categories.toLowerCase()}`}
            >
            ...
            {filters.searchTerm && (
              <span className='inline-flex items-center px-3 py-1 bg-primary-100 dark:bg-primary-700/30 text-primary-700 dark:text-primary-300 rounded-full text-sm'>
                ...
                <button
                  ...
                  aria-label={`${t.delete}: ${t.search}`}
                  title={`${t.delete}: ${t.search}`}
                >
                  <X className='w-3 h-3' />
                </button>
              </span>
            ...
            {filters.categories.map((cat) => (
              ...
              >
                ...
                <button
                  ...
                  className='ml-2 hover:text-primary-900 dark:hover:text-primary-100'
                  aria-label={`${t.delete}: ${translateCategory(cat, language)}`}
                  title={`${t.delete}: ${translateCategory(cat, language)}`}
                >
                  <X className='w-3 h-3' />
                </button>
              </span>
            ...
            {filters.startDate && (
              <span className='inline-flex items-center px-3 py-1 bg-primary-100 dark:bg-primary-700/30 text-primary-700 dark:text-primary-300 rounded-full text-sm'>
                ...
                <button
                  ...
                  className='ml-2 hover:text-primary-900 dark:hover:text-primary-100'
                  aria-label={`${t.delete}: ${t.from}`}
                  title={`${t.delete}: ${t.from}`}
                >
                  <X className='w-3 h-3' />
                </button>
              </span>
            ...
            {filters.minAmount && (
              <span className='inline-flex items-center px-3 py-1 bg-primary-100 dark:bg-primary-700/30 text-primary-700 dark:text-primary-300 rounded-full text-sm'>
                ...
                <button
                  ...
                  className='ml-2 hover:text-primary-900 dark:hover:text-primary-100'
                  aria-label={`${t.delete}: ${t.minimumAmount}`}
                  title={`${t.delete}: ${t.minimumAmount}`}
                >
                  <X className='w-3 h-3' />
                </button>
              </span>
            ...
            {filters.maxAmount && (
              <span className='inline-flex items-center px-3 py-1 bg-primary-100 dark:bg-primary-700/30 text-primary-700 dark:text-primary-300 rounded-full text-sm'>
                ...
                <button
                  ...
                  className='ml-2 hover:text-primary-900 dark:hover:text-primary-100'
                  aria-label={`${t.delete}: ${t.maximumAmount}`}
                  title={`${t.delete}: ${t.maximumAmount}`}
                >
                  <X className='w-3 h-3' />
                </button>
              </span>

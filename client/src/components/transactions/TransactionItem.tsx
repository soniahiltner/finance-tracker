...
const TransactionItem = memo(
  ({ transaction, onEdit, onDelete }: TransactionItemProps) => {
    ...
    return (
      <div className='flex items-center justify-between p-4 max-xxs:p-2 hover:bg-gray-200/30 dark:hover:bg-gray-700/50 rounded-lg transition-colors border border-gray-200 dark:border-gray-700'>
